...
\Cref{fig:mnsist-accuracy-comparison} compares the schemes in the non-\ac{iid} setting when the ratio of malicious users is $50\%$.
...
Finally, \Cref{fig:shield-fl-performance-with-iid-data} presents ShieldFL performance with \ac{iid} data when the malicious users ratio is $50\%$.
